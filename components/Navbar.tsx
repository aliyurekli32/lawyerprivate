...
const Navbar = () => {
  ...
  <div className="navbar-start text-2xl">
    ...
    <a onClick={()=>{changeNum(1)}} className="normal-case w-24 h-24"> <img className="w-24 h-24" src="https://github.com/aliyurekli32/lawyerprivate/blob/main/images/Logo.png"  alt="" /> </a>
  </div>
